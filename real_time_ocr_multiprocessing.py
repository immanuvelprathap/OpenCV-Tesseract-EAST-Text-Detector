...
#
#  Usage: python real_time_ocr_multiprocessing.py --east frozen_east_text_detection.pb
#         or
#         python real_time_ocr_multiprocessing.py --east frozen_east_text_detection.pb --video test.avi
#
